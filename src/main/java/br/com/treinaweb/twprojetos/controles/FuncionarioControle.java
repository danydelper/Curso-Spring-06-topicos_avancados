...
public class FuncionarioControle {
    ...
    public String cadastrar(@Valid Funcionario funcionario, BindingResult resultado, ModelMap model, RedirectAttributes attrs) {
        ...
        attrs.addFlashAttribute("alert", new AlertDTO("Funcionario cadastrado com sucesso", "alert-sucess"));
    ...
    public String editar(@Valid Funcionario funcionario, BindingResult resultado, @PathVariable Long id, ModelMap model, RedirectAttributes attrs) {
        ...
        funcionarioRepositorio.save(funcionario);
        attrs.addFlashAttribute("alert", new AlertDTO("Funcionario editado com sucesso", "alert-sucess"));
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        ...
        attrs.addFlashAttribute("alert", new AlertDTO("Funcionario excluido com sucesso", "alert-sucess"));
