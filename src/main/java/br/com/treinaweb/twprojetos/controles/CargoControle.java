...
public class CargoControle {
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        try {
            ...
            attrs.addFlashAttribute("alert", new AlertDTO("Cargo excluido com sucesso", "alert-warning"));
        } catch (CargoPossuiFuncionariosException e) {
            attrs.addFlashAttribute("alert", new AlertDTO("Cargo não pode ser excluido, pois possui funcionário(s) relacionados", "alert-danger"));
        }
        return "redirect:/cargos";
    }
